...
(function(){
  ...
  // Mereu vizibil pe telefon (pastila din meniu e ascunsă acolo), deci nu
  // depinde de lungimea paginii ca săgeata — altfel pe paginile scurte n-ar
  // mai exista niciun buton de căutare.
})();
</script>
"""
...
def build_letopiset(shell):
    ...
    main = ('    <div class="wrap" style="max-width:760px;margin:0 auto;padding:0 20px">\n'
            ...
            f'style="color:inherit">USGS</a>, <a href="https://www.gdacs.org" target="_blank" '
            f'rel="noopener" style="color:inherit">GDACS</a>, '
            f'<a href="https://eonet.gsfc.nasa.gov" target="_blank" rel="noopener" style="color:inherit">NASA EONET</a>, '
            f'<a href="https://www.spc.noaa.gov/climo/reports/" target="_blank" rel="noopener" style="color:inherit">NOAA SPC</a>, '
            f'<a href="https://www.cpc.ncep.noaa.gov/products/analysis_monitoring/enso_advisory/ensodisc.shtml" '
            f'target="_blank" rel="noopener" style="color:inherit">NOAA CPC</a>, '
            f'<a href="https://www.who.int/emergencies/disease-outbreak-news" target="_blank" rel="noopener" style="color:inherit">OMS</a>, '
            f'<a href="https://open-meteo.com" target="_blank" rel="noopener" style="color:inherit">Open-Meteo / ERA5</a> '
            f'(media 1991–2020).</p>\n'
            '      </div>\n'
